namespace PetGrooming.Migrations
{
    ...
    public partial class one_one_relationships_aspuser : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.GroomBookings", "GroomerID", c => c.String(maxLength: 128));
            AlterColumn("dbo.GroomBookings", "OwnerID", c => c.String(maxLength: 128));
            AlterColumn("dbo.Groomers", "GroomerID", c => c.String(nullable: false, maxLength: 128));
            AlterColumn("dbo.Owners", "OwnerID", c => c.String(nullable: false, maxLength: 128));
            AlterColumn("dbo.PetOwners", "Owner_OwnerID", c => c.String(nullable: false, maxLength: 128));
